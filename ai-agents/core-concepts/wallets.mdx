...
<Tabs>
  <Tab title="BANKR Wallet">
    ...
    **Cómo funciona:** Instala el skill de wallet de BANKR, y tu agente obtiene la capacidad de verificar balances, enviar tokens e interactuar con protocolos DeFi. Las claves son almacenadas y gestionadas por BANKR.
...
- **Mantener stablecoins**: recibir y almacenar USDC u otros tokens
...
- **Interactuar con protocolos**: llamar smart contracts para intercambiar tokens, proporcionar liquidez o usar otros servicios onchain
