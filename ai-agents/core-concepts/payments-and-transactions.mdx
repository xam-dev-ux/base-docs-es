...
x402 permite que tu agente pague por solicitudes de API usando stablecoins sin suscripciones o claves de API. Tu agente solicita un recurso, el servidor le dice el precio, tu agente paga y el servidor entrega los datos.
...
Los skills cubren acciones como verificar el balance de un token, ejecutar un intercambio, enviar un pago o llamar a un smart contract.
